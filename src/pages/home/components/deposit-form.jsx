...
import { handlePostDeposit } from "../../../assets/api";

const schema = yup
  .object({
    order_id: yup.string().required("Order ID must be filled"),
    amount: yup
      .number()
    ...
    timestamp: yup.string().required("Timestamp cannot be empty"),
  })
  .required();
...
const DepositForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const response = await handlePostDeposit(payload);
    if (response) {
      reset();
    }
  };
